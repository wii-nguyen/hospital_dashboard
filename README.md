...
Piedmont Healthcare executives want to evaluate and improve patient experience across Piedmont hospitals in Georgia. They want to (1) identify key drivers of patient satisfaction, (2) highlight hospital-level strengths and weaknesses that directly influence overall patient reception and (3) benchmark hospital-level performance against national and state standards.
...
## 4. Questions (KPIs):
  •	How do these KPIs perform year-over-year?
      o Overall satisfaction – star rating.
      o Likelihood to recommend hospital - star rating.
      o Summary star rating across all domains.
